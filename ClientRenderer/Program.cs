...
{
    File.WriteAllText(osuApiConfigFilePath, JsonSerializer.Serialize(new OsuApiV2Configuration(), new JsonSerializerOptions { WriteIndented = true }));
...
{
    File.WriteAllText(rendererSettingsFilePath, JsonSerializer.Serialize(new RendererCredentials(), new JsonSerializerOptions { WriteIndented = true }));
